 ...
 */
const toArray = (noiseFunction, xLength, yLength, zLength) => {
 ...
 */
const toDepthTexture = (data, xLength, yLength, zLength) => {
 ...
 */
const noiseBlueprint = (inputTransformation, outputTranformation, sampleScale) => {
	return {
		inputTransformation,
 ...
 */
const getBufferedNoise = (blueprint) => {
 ...
 */
const createBufferedNoise = (inputTransformation, outputTransformation, sampleScale) => {
 ...
 */
const getLayeredNoise = (noiseBlueprints) => {
...
module.exports = {
	noise: noise,
	toArray: toArray,
	toDepthTexture: toDepthTexture,
	noiseBlueprint: noiseBlueprint,
    bufferNoise: bufferNoise,
	getBufferedNoise: getBufferedNoise,
	createBufferedNoise: createBufferedNoise,
	getLayeredNoise: getLayeredNoise
}
